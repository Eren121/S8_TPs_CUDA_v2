...
// Version: pas d'optimisation, juste gestion de la grille par ligne / colonne indépendantes
// Limité en 1024x1024 (si NBTHREADS_MAX=1024)
...
int main(int argc, char **argv) {
    ...
    stbi_write_tga("generated/blurry_v2.tga", w, h, comps, h_out);
